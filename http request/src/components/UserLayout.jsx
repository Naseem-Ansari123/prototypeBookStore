...
const UserLayout = () => {
  ...
  const handleSearch = (e) => {
    ...
    navigate(`/user/books?search=${encodeURIComponent(query)}`);
      ...
      >
        ...
        <div className="flex h-[72px] items-center justify-between border-b border-slate-100 px-5">
          ...
          >
            ...
            <div>
              <h1 className="bg-gradient-to-r from-cyan-600 to-blue-700 bg-clip-text text-xl font-bold text-transparent">
                BookVerse
              </h1>
        ...
        <div className="flex-1 overflow-y-auto px-4 py-6">
          ...
          {/* Seller CTA */}
          <div className="mt-8 rounded-2xl bg-gradient-to-br from-cyan-500 to-blue-600 p-4 text-white">
            ...
            <p className="mt-1 text-xs leading-5 text-cyan-50">
              Join BookVerse and start selling your books online.
            </p>

            <button
              onClick={() => navigate("/admin")}
              className="mt-4 w-full rounded-lg bg-white py-2 text-xs font-semibold text-blue-600 transition hover:bg-slate-100"
            >
              Become a Seller
            </button>
          </div>
        ...
        <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/95 backdrop-blur-xl">
          ...
          <div className="flex h-[72px] items-center gap-3 px-4 sm:px-6 lg:px-8">
            ...
            <button
              ...
              className="relative flex h-10 w-10 shrink-0 items-center justify-center rounded-xl text-slate-600 transition hover:bg-slate-100 hover:text-cyan-600"
            ...
            <button
              ...
              className="hidden h-10 w-10 items-center justify-center rounded-xl text-slate-600 transition hover:bg-slate-100 hover:text-red-500 sm:flex"
              aria-label="Wishlist"
            >
            ...
            >
              <button
                ...
                className="flex items-center gap-2 rounded-full border border-slate-200 p-1 pr-2 transition hover:border-cyan-300 hover:bg-slate-50"
              >
                <img
                  src="https://api.dicebear.com/7.x/bottts/svg?seed=lulijJbr2GN2zgp2Ps_hM"
                  alt="Profile"
                ...
                <ChevronDown
                  className={`
                    hidden h-4 w-4 text-slate-400 transition-transform
                    sm:block
