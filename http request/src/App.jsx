      ...
      <div className="bg-white rounded-lg w-[80%] mx-auto gap-5 mt-13 p-8 flex justify-between">
        <div className="w-[30%] border-2 rounded-lg p-5 border-gray-300">
          ...
          <form onSubmit={id ? editProduct : createProducts} className="flex flex-col mt-3 space-y-4">
            <input onChange={handleChange} value={product.title} name="title" type="text" placeholder="Title" className="w-full rounded-xl border px-4 py-3 focus:ring-2 focus:ring-indigo-500 outline-none" required />
            <input onChange={handleChange} value={product.price} name="price" type="number" placeholder="Price" className="w-full rounded-xl border px-4 py-3 focus:ring-2 focus:ring-indigo-500 outline-none" required />
            <input onChange={handleChange} value={product.discount} name="discount" type="number" placeholder="Discount" className="w-full rounded-xl border px-4 py-3 focus:ring-2 focus:ring-indigo-500 outline-none" required />
            <input onChange={handleChange} value={product.category} name="category" type="text" placeholder="Category" className="w-full rounded-xl border px-4 py-3 focus:ring-2 focus:ring-indigo-500 outline-none" required />
            <input onChange={handleChange} value={product.image} name="image" type="text" placeholder="Image" className="w-full rounded-xl border px-4 py-3 focus:ring-2 focus:ring-indigo-500 outline-none" required />
            <textarea onChange={handleChange} value={product.description} name="description" id="desc" name="description" placeholder="Description" className="w-full rounded-xl border px-4 py-3 focus:ring-2 focus:ring-indigo-500 outline-none" required></textarea>
            {
              id ?
